  ...
  return (
    <section id="contact" className="py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-10">
        <div className="rounded-2xl bg-[#0F172A] p-8 sm:p-12 lg:p-16 overflow-hidden relative">
          {/* Gradient orbs */}
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="rounded-2xl bg-surface p-7 sm:p-8 shadow-xl shadow-black/10 space-y-5">
                  <div>
                      ...
                      {showMore && (
                        ...
                        >
                          <div className="pt-4 space-y-4">
                            ...
                            <div>
                              <label htmlFor="about" className="block text-[13px] font-semibold text-text mb-1.5">Anything specific you want to improve?</label>
                              <textarea id="about" name="about" rows={3} placeholder="e.g. We're missing calls after hours, admin is eating up half our day..."
