          ...
          {serviceAreas.map((area, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="group rounded-2xl bg-bg border border-border p-7 transition-all duration-300 hover:shadow-md hover:border-primary/20 flex flex-col"
              >
                ...
                <Link
                  ...
                  className="mt-auto pt-5 flex items-center gap-1.5 text-[13px] font-semibold text-primary hover:text-primary-dark transition-colors"
                >
